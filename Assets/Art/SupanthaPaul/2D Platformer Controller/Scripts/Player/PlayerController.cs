...
namespace SupanthaPaul
{
	public class PlayerController : MonoBehaviour
	{
		...
		[Tooltip("Amount of time (in seconds) the wolf will be in the dashing speed")]
		[SerializeField] private float startDashTime = 0.1f;
		[Tooltip("Time (in seconds) between dashes")]
		[SerializeField] private float dashCooldown = 0.2f;
		[SerializeField] private GameObject dashEffect;

		// Access needed for handling animation in Wolf script and other uses
		...
		void Start()
		{
			...
			// if it's the wolf, make this instance currently playable
		...
		private void FixedUpdate()
		{
			...
			// calculate wolf and wall sides as integers
			CalculateSides();
